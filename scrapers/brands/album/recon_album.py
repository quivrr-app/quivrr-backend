...
URLS = [
    "https://albumsurf.com",
    "https://albumsurf.com/collections/surfboards",
    "https://albumsurf.com/collections/all",
]

OUTPUT_FILE = Path("scrapers/brands/album/output/album_recon.json")
