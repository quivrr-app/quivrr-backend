...
URLS = [
    ...
    "https://christensonsurfboards.com/collections/surfboards",
    "https://christensonsurfboards.com/collections/all",
]

OUTPUT_FILE = Path("scrapers/brands/christenson/output/christenson_recon.json")
