...
OUTPUT_FILE = Path("scrapers/brands/output/pyzel_dhd_recon_report.json")
...
BRANDS = {
    "pyzel": [
        ...
        "https://pyzelsurfboards.com.au",
        "https://www.pyzelsurfboards.com.au",
    ],
    "dhd": [
        "https://dhdsurf.com",
        "https://www.dhdsurf.com",
        "https://dhdsurf.com.au",
        "https://www.dhdsurf.com.au",
    ],
}
...
def fetch(url):
    try:
        ...
        return {
            ...
            "product_links_found": sorted(set(product_links))[:50],
            "product_links_count": len(set(product_links)),
            "collection_links_found": sorted(set(collection_links))[:50],
