...
URLS = [
    ...
    "https://sharpeyesurfboards.com/collections/surfboards",
    "https://www.sharpeyesurfboards.com/collections/surfboards",
]

OUTPUT_FILE = Path("scrapers/brands/sharpeye/output/sharpeye_recon.json")
