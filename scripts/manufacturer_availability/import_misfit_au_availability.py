...
INPUT_PATH = Path("scrapers/manufacturers/availability/output/misfit/misfit_au_manufacturer_inventory.json")
...
def main():
    ...
    print("Importing Misfit Shapes AU manufacturer availability")
    ...
    print("")
    print("Misfit Shapes AU manufacturer availability import complete")
