...
INPUT_PATH = Path("scrapers/manufacturers/availability/output/chilli/chilli_au_manufacturer_inventory.json")
...
def main():
    ...
    print("Importing Chilli AU manufacturer availability")
    ...
    print("")
    print("Chilli AU manufacturer availability import complete")
