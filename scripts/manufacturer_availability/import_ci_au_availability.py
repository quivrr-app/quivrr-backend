...
INPUT_FILE = Path("scrapers/manufacturers/availability/output/channel_islands/ci_au_manufacturer_inventory.json")
...
def main():
    ...
    with engine.begin() as conn:
        ...
        if not brand_id:
            raise RuntimeError("Channel Islands brand not found")
        ...
        for row in rows:
            ...
            """), {
                ...
                "brand_name": clean(row.get("brandName")) or "Channel Islands",
                "model_name": model_name,
