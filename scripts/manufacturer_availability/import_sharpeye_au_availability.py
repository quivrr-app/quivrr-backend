...
INPUT_PATH = Path("scrapers/manufacturers/availability/output/sharpeye/sharpeye_au_manufacturer_inventory.json")
...
def main():
    ...
    print("Importing Sharp Eye AU manufacturer availability")
    ...
    print("")
    print("Sharp Eye AU manufacturer availability import complete")
