...
INPUT_PATH = Path("scrapers/manufacturers/availability/output/lost/lost_au_manufacturer_inventory.json")
...
def main():
    ...
    print("Importing Lost AU manufacturer availability")
    ...
    print("")
    print("Lost AU manufacturer availability import complete")
