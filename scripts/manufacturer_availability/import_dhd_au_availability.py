...
INPUT_PATH = Path("scrapers/manufacturers/availability/output/dhd/dhd_au_manufacturer_inventory.json")
...
def main():
    ...
    print("Importing DHD AU manufacturer availability")
    ...
    for item in rows:
        ...
        insert_row(cursor, columns, item, brand_id, board_model_id, board_size_id)
    ...
    print("")
    print("DHD AU manufacturer availability import complete")
