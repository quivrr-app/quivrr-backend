...
INPUT_PATH = Path("scrapers/manufacturers/availability/output/christenson/christenson_au_manufacturer_inventory.json")
...
def main():
    ...
    print("Importing Christenson AU manufacturer availability")
    ...
    print("")
    print("Christenson AU manufacturer availability import complete")
