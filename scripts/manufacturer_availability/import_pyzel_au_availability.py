...
INPUT_PATH = Path("scrapers/manufacturers/availability/output/pyzel/pyzel_au_manufacturer_inventory.json")
...
def main():
    ...
    print("Importing Pyzel AU manufacturer availability")
    ...
    print("")
    print("Pyzel AU manufacturer availability import complete")
