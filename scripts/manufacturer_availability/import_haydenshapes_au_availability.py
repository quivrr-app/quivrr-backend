...
INPUT_PATH = Path("scrapers/manufacturers/availability/output/haydenshapes/haydenshapes_au_manufacturer_inventory.json")
...
def main():
    ...
    print("Importing Haydenshapes AU manufacturer availability")
    ...
    print("")
    print("Haydenshapes AU manufacturer availability import complete")
