...
def conform_inventory_payload_for_sql(payload: dict) -> dict:
    # Keep raw scrape artifacts unchanged and only conform DB-bound decimals to
    # the existing RetailerInventory schema. This avoids pyodbc batch precision
    # loss when executemany sees mixed Decimal scales such as 649.00 and 1.71000.
