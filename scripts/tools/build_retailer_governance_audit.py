...
BUSINESS_DISABLED = {
    ...
    "red_herring_surf": "Board Collective storefront shell with no retailer-distinct public surfboard inventory; exclude to avoid duplicate retailer coverage",
    "rip_curl_australia": "Does not sell hardboard surfboard inventory online for Quivrr search",
    "saltwater_wine_port_macquarie": "Board Collective storefront shell with no retailer-distinct public surfboard inventory; exclude to avoid duplicate retailer coverage",
