...
- [Regional Rollout](REGIONAL_ROLLOUT.md) defines mandatory RegionCode rules, active AU/EU/ID/US behavior, the standard coverage workflow, UK planning, validation steps, and activation guardrails.
